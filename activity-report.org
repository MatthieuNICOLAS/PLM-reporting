...
- Refactorer les *BatExercise*
  ...
  - Ce qui pose problème est l'affichage
    ...
    - Il suffit de gérer ce problème du côté de l'UI
      - Récupèrer l'*expected* à partir du monde solution envoyé à l'initialisation de l'UI
      - Modifier les opérations pour se contenter d'envoyer les nouveaux *result* au lieu de renvoyer tout le monde
*** Planned
**** TODO Refactorer les BatExercise
