...
- Internationalisation
  ...
  - Quel outil utilisé pour rédiger la traduction?
    ...
    - [[http://basmussen.github.io/i18n-maven-plugin/index.html][Ce plugin]] semble simple d'utilisation, mais à voir comment le configurer.
...
*** Questions
*** Planned
**** TODO Pouvoir redémarrer un exercice
...
**** TODO Supporter l'internationalisation
