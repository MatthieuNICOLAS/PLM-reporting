...
- Permettre de stopper l'exécution
  ...
  - Ceci empêche de stopper l'exécution
    - Si une demande d'arrêt de l'exécution est reçue, elle ne sera traité qu'une fois que l'exécution se soit terminée
