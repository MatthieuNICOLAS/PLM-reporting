...
- Améliorer la gestion de la machine TELECOM Nancy
  ...
  - Mais bugs:
    ...
    - A tenté de checkout une autre branche le temps depuis le script *pre-receive* mais message d'erreur "n'est pas un repo Git" (à revérifier)
*** Questions
...
*** Planned
**** TODO Fixer les tests des entités solutions
