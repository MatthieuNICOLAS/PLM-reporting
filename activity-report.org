...
- Merger les branches master et prod-judge
  ...
  - Fusionner les branches de webPLM *master* et *prod-judge*
    ...
    - Problème avec les opérations
      - Le format des opérations provenant du *Tribunal* et du *ExecutionSpy* sont différents
      - Celles provenant du *Tribunal* en besoin d'être parser par le client avant d'être traitées
*** Planned
...
**** TODO Merger les branches master et prod-judge
...
- [ ] Merger les fichiers de configuration
...
**** TODO Gérer les leçons et exercices dans webPLM
