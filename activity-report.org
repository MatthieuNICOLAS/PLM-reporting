...
- Mise en place d'un service d'authentification
  - Recherche de librairies permettant de mettre en place un service OAuth
    ...
    - Ces projets utilisant *Node.js*, utiliser [[http://mean.io/][MEAN]] pour créer la base de l'application semble une bonne idée
*** Planned
...
**** TODO Mettre en place un service d'authentification
...
**** TODO Mettre en place un service de profil
...
**** TODO Ajouter l'évènement IDLE à la branche master de PLM
