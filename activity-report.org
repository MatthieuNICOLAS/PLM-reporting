...
*** Planned
**** TODO Déployer une version de démonstration
- Si PLM doit être présentée, une version de démonstration accessible facilement semble utile
...
**** TODO Ajouter à l'UI un composant permettant de choisir la langue du programme
