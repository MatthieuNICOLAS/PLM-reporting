...
- Résoudre le problème de synchronisation entre le repo local et le repo GitHub lors du 1er démarrage de webPLM
  ...
  - S'assurer que *TrackingRefUpdate* correspond bien à ce que l'on souhaite
    - [ ] Voir le résultat de /getTrackingRefUpdates()/ si la branche n'existe pas sur le repo distant
    - [ ] Voir le résultat de /getTrackingRefUpdates()/ si la branche existe sur le repo distant et est en avance sur le repo local
