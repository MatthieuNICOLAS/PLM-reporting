...
**** TODO Modifier l'UI en fonction des retours
- Retirer la classe /panel/ qui englobe les consignes
- Retirer le texte par défaut dans le bloc /Execution results/
- Déplacer le choix de la langue et du langage de programmation dans la barre de menu
...
**** TODO Tester le serveur local à TELECOM Nancy
...
**** TODO Corriger bug Welcome / LoopWhile
...
**** TODO Faire une image Docker du service d'authentification
**** TODO Faire une image Docker du service de profil
