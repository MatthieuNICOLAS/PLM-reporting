...
- Refactorer setLocale
  ...
  - Puisque à terme, un instance de Game correspondra à une session d'utilisation, j'ai modifié PLMActor pour qu'il définisse la langue à utiliser à son instanciation.
  - Voir la partie *Questions*
*** Questions
- Aller plus loin dans le refactoring de setLocale?
  - Quand l'utilisateur change la langue de l'application, je ne vois pas comment mettre à jour la page (notamment les directives AngularJS) sans forcer l'utilisateur a rechargé la page
