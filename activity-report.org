...
- Nettoyage du code
  ...
  - Utilisation de /Exercise.toJSON()/
    - Pas le même format qu'auparavant
      - On note juste les cellules qui diffèrent de la cellule "défaut"
      - Les entités sont sous la forme de tableau et non de hashmap
