...
- Retravailler ExerciseController
  ...
  - Tous les mondes n'ont pas non plus d'un monde objectif, d'une démo, d'un historique...
...
*** Questions
*** Planned
**** TODO Refactorer le service canvas
- Voir pour sortir la méthode de dessin du monde des Buggles du modèle
- La boucle d'animation devrait elle aussi se trouver dans le service et non pas dans le controller.
