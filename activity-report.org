...
**** TODO Ajouter la fonctionnalité permettant de signaler un bug
**** TODO Corriger les problèmes & bugs détectés lors du test en mode local
- [ ] Manque *CLIENT_SECRET* de Google & GitHub
...
**** TODO Rediriger l'utilisateur à l'accueil à la fin d'une leçon
...
- Rédiger README
- Revoir LICENSE
**** TODO Rédiger la documentation expliquant comment traduire l'application
