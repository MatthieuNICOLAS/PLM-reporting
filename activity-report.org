...
**** TODO Instancier les leçons dans webPLM
...
**** TODO Exposer les nouveaux objets décrivant les leçons
- Implémenter un acteur fournissant une API permettant de
  - Récupérer la liste des leçons
  - Récupérer la liste des exercices d'une leçon
**** TODO Mettre en place un script exportant les leçons de PLM au format JSON
...
- Implémenter un acteur fournissant une API peremttant de récupérer un exercice
