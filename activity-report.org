...
- Lorsque plusieurs utilisateurs exécutent en concurrence un programme sur un même exercice, leur programmes modifient le monde simultanément
**** TODO Déplacer les univers se trouvant dans /src/lessons/
...
**** TODO Ajouter une méthode /exerciseFromJSON()/ à *ExerciseFactory*
- Cette méthode servira à re-créer les exercices dans les juges à partir du JSON fourni par le *Tribunal*
**** TODO Refactorer les juges
- Le refactoring PLM a modifé comment on instancie un exercice et exécute le code d'un élève
- Modifier les juges en conséquences
**** TODO Refactorer le *Tribunal*
