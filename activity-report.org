...
- Modifier le processus de l'exécution d'un exercice
  ...
  - Permet de lancer le code de l'élève sur un exercice
    ...
    - [ ] Transmet les opérations générées par l'exécution au client
    - [ ] Génère un *ExecutionProgress* indiquant le résultat de l'exécution
  - Modification de *PLMActor*
    - /runExercise/ envoie dorénavant le message /StartExecution/ à l'*ExecutionActor*
*** Planned
