...
**** TODO Limiter la consommation en ressource des juges
...
- Limiter les ressources des juges:
  - RAM
  - Vitesse de calcul
**** TODO Déployer la version avec le contrôle des ressources
- Déployer la nouvelle version limitant la capacité 
**** TODO Générer le commit concernant l'exécution dans webPLM
...
**** TODO Résoudre bug concernant la taille du canvas
