...
*** Questions
*** Planned
**** TODO Voir pour améliorer la gestion de la boucle dessin
- Remplacer setTimeout/Interval par $timeout/interval
- /$scope.$apply()/ nécessaire?
**** TODO Corriger bug d'AngularJS avec ng-bind-html
...
**** TODO Corriger les erreurs liées aux Program Steps
