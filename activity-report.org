...
- Trouver un moyen de récupérer la date de la dernière version du code de l'élève que l'on stocke
  - Avec /JGit/, on peut "facilement" retrouver les commits concernant un fichier avec *LogCommand*
    ...
    - /log().setMaxCount(1)/ peremt de filtrer le nombre de commit que l'on souhaite récupérer
  ...
  - Reste à voir si
    ...
    - [ ] c'est plus intéressant pédagogiquement de les travailler sur le sujet, je me contente de répondre à leurs questions
*** Done
