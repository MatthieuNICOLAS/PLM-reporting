...
- Corriger les bugs d'interfaces pour la présentation de Martin aux profs d'ISN
  ...
  - Issue #75
    - Je me suis contenter de retirer la mention au graphe de progression pour le moment
*** Planned
...
- [ ] https://github.com/BuggleInc/webPLM/issues/79: Demo empty in the last exercise of Tri-color Hanoi Towers
- [X] https://github.com/BuggleInc/webPLM/issues/71: An infinite loop loops infinitely (stop button is useless)
- [ ] https://github.com/BuggleInc/webPLM/issues/58: Hints do not seem to be implemented
