...
- Préparer les slides pour la présentation de PLM au sein de l'équipe
  ...
  - [ ] Ajouter des slides concernant les publics visés
    - Elèves
    - Enseignants
    - Chercheurs
  - [ ] Ajouter des slides pour expliquer le problème du singleton *Game*
  ...
  - [ ] Développer la partie /Next steps/
    - [ ] Développer la slide sur le refactoring
...
**** TODO Préparer les slides pour la présentation de PLM au sein de l'équipe
...
- Comme PLM est un projet à part de l'équipe, et que tous les membres ne sont pas familiers avec, il a été proposé que je fasse une présentation
