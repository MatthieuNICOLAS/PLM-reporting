...
- Couplage Controller/Acteur
  ...
  - Lors qu'un utilisateur s'identifie auprès d'un controller, celui retrouver l'acteur à l'aide de l'UUID et lui envoie un message
*** Questions
*** Planned
...
**** TODO Implémenter la gestion des comptes utilisateurs
