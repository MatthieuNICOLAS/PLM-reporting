...
**** TODO Corriger bug boucle infinie récursive
...
- Trouver
**** TODO Refactorer Game
- Modifier Game pour qu'il ne soit plus un singleton
- Séparer Game en 3 objets
  - Le contenu commun à tous les utilisateurs (leçons disponibles, mondes initiaux et objectifs des exercices, langages de programmation disponible...)
  - La session courante de l'utilisateur (leçon sélectionnée, exercice en cours, monde de travail...)
  - Les préférences de l'utilisateur (langue par défaut, langage de programmation...)
**** TODO Améliorer la gestion de la machine TELECOM Nancy
...
- Ajouter la conversion du monde en JSON
- Générer les opérations représentant les actions du programme de l'utilisateur
- Ajouter le modèle côté client
- Implémenter la vue du monde
**** TODO Empêcher LightBot de faire crasher le serveur
